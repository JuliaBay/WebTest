	...
	{		
		...
		try
		{
			...
			if(!isset($form_fields["f_ID"]))
				...
				DBEditUser($f_ID,$f_name,$f_log,$f_dep_ID,$f_email,$f_pass);			
			...
			<div id="reg-form">
				<fieldset>
					<form action="" method="POST">
						...
						<input id="format_message" type="checkbox" name="format_message" checked="1">Студент<label for="format_message">Преподаватель <b><BR></b></label>
